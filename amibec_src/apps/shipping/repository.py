...
class HandDelivery(methods.NoShippingRequired): # hand delivery, eg for customers located near company premises
    code = "hand-delivery"
    ...
    def get_available_shipping_methods(self, basket, user=None, shipping_addr=None, request=None, **kwargs):
        ...
        if shipping_addr :
            ...
            if weightbased_set :
                ...
                # no shipping method is available for shipping country, error message will be 
                # displayed by oscar core
                methods = []
