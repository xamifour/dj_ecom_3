...
$(document).ready(function(){
    ...
    var searchInput = searchForm.find("[name='productSearch']") // input name='q'
    var typingTimer;
    var typingInterval = 1500 // .15 seconds
    ...
    function perfomSearch(){
      ...
      setTimeout(function(){
        window.location.href='/products/qs?productSearch=' + query
      }, 1000)
  ...
  productForm.submit(function(event){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          if (data.added){
            submitSpan.html("<div class='btn-group'><a class='btn btn-link' href='/cart/' style='text-decoration: none !important;'>In cart</a><button type='submit' class='btn btn-link'><span class='text-danger'>Remove</span></button></div>")
          } else {
            submitSpan.html("<button type='submit' class='btn btn-primary' style='width:100%;' >Add to cart</button>")
           }
